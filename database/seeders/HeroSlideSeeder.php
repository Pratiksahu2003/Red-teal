...
class HeroSlideSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $slides = [
            ['category' => 'Data Centre', 'title' => 'VDC800 Oslo DC-1 Delivers 45MW of Sustainable Power', 'description' => 'Our flagship Nordic facility runs on 100% renewable energy with a PUE of 1.12 — enterprise-grade colocation built for the future of digital infrastructure.', 'image' => 'images/hero-slide-1.jpg', 'cta_text' => 'Read More', 'cta_url' => '/data-centre', 'sort_order' => 1],
