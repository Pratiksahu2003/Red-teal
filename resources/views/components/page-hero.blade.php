...
<section class="relative pt-8 lg:pt-10 pb-16 lg:pb-20 bg-brand-900 text-white overflow-hidden {{ $heightClass }} flex {{ $alignClass }}">
    <div class="absolute inset-0">
        <img src="{{ hero_image_url($image, $fallback) }}" alt="{{ $alt }}" class="w-full h-full object-cover">
    ...
    <div {{ $attributes->merge(['class' => 'relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-2']) }}>
        {{ $slot }}
    </div>
</section>
