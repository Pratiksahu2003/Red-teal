<nav x-data="{ open: false, servicesMenu: false, solutionsMenu: false, mobileServicesOpen: false, mobileSolutionsOpen: false }" @keydown.escape.window="open = false; servicesMenu = false; solutionsMenu = false" class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-brand-200 shadow-sm">
        ...
        <div class="flex items-center justify-between h-16 lg:h-[4.5rem]">
            ...
            <div class="hidden lg:flex items-center gap-6 xl:gap-8">
                ...
                <div class="relative" @click.outside="servicesMenu = false">
                    <button
                        type="button"
                        @click="solutionsMenu = false; servicesMenu = !servicesMenu"
                ...
                <div class="relative" @click.outside="solutionsMenu = false">
                    <button
                        type="button"
                        @click="servicesMenu = false; solutionsMenu = !solutionsMenu"
                        class="inline-flex items-center gap-1.5 text-sm font-medium rounded-lg px-2.5 py-1.5 transition"
                        :class="solutionsMenu
                            ? 'text-brand-teal-700 ring-2 ring-brand-teal-500/25 bg-brand-teal-50/50'
    ...
    <div x-show="open" x-cloak x-transition class="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-brand-200 shadow-lg z-50 max-h-[calc(100vh-4rem)] overflow-y-auto">
        <div class="px-4 py-6 space-y-1">
            ...
            <div class="border-b border-brand-100 pb-2">
                <button
                    type="button"
                    @click="mobileSolutionsOpen = false; mobileServicesOpen = !mobileServicesOpen"
            ...
            <div class="border-b border-brand-100 pb-2">
                <button
                    type="button"
                    @click="mobileServicesOpen = false; mobileSolutionsOpen = !mobileSolutionsOpen"
                    class="flex w-full items-center justify-between text-brand-700 font-medium py-2.5 hover:text-brand-red-500"
                >
                    <span>Solutions</span>
            ...
            <a href="{{ route('blog.index') }}" class="block text-brand-700 font-medium py-2.5 hover:text-brand-red-500">Blog</a>
